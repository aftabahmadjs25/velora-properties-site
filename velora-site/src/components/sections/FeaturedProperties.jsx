                        ...
                        <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 bg-gradient-to-t from-dark-blue/90 to-transparent">
                            ...
                            <div className="flex justify-between items-end">
                                ...
                                <div className="text-right">
                                    ...
                                    <button className="flex items-center gap-2 text-sm uppercase tracking-wider hover:text-primary transition-colors border border-white/30 rounded-full px-4 py-2 hover:bg-white hover:text-dark-blue">
